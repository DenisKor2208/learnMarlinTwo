                    ...
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="oliver kopyov">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <?php endif; ?>
                                    <span class="text-truncate text-truncate-xl"><?php echo $value['company']; ?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:<?php echo $value['phone_number']; ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i> <?php echo $value['phone_number']; ?></a>
                                ...
                                <div class="d-flex flex-row">
                                    ...
                                    <a href="https://t.me/<?php echo $value['telegram']; ?>" class="mr-2 fs-xxl" style="color:#38A1F3">
                                        <i class="fab fa-telegram"></i>
                                    </a>
                                    <a href="https://www.instagram.com/<?php echo $value['instagram']; ?>" class="mr-2 fs-xxl" style="color:#E1306C">
